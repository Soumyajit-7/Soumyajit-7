...
<img align="center" alt="Coding GIF" width="100%" src="https://raw.githubusercontent.com/devSouvik/devSouvik/master/gif3.gif" />
...
🚀 **MrDat - Automated Data Cleaning Platform**
- 🤖 AI-powered data cleaning with LLaMA-3.3 and multi-agent systems
- ⚡ Automated 80% of data preprocessing tasks
- 🛠️ Tech: Python, FastAPI, Airflow, PostgreSQL, Groq

🎯 **SafeRoute AI - Pothole Detection System**
- 📹 Real-time computer vision at 15 FPS
- 🎯 95% accuracy with custom YOLOv8 model
- 🗺️ Automated mapping and reporting system

🤖 **Robotic Waste Sorting Machine** (Patent Pending)
- 🧠 Deep learning with 96.4% accuracy on TrashNet
- ⚡ Sub-50ms inference latency
- 🔄 Automated sorting with servo-actuated system
